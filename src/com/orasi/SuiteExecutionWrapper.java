...
//* A staging configuration containing a Staging URL */
      ...
      if ( cli.hasOption( "h" ) ) {
        ...
        formatter.printHelp("java -jar sa", SuiteExecutionWrapper.instance().getOptions() );
        System.exit( 0 );
      }

      if ( cli.hasOption( "q" ) ) {
        System.out.println( "Suite" );
        System.out.println( "sa (Suite): 27297.2047" ); 
        System.out.println( "\r\nTests" );
        System.out.println( "Test1 (Test): 27297.2057" );
        
        System.out.println( "\r\nFunctions" );
        
        
        System.out.println( "\r\nExecution Targets" );
	System.out.println( "sa router (Router): 27297.2050" );
	System.out.println( "Chrome (Execution Target): 27297.2051" );
	System.out.println( "Firefox (Execution Target): 27297.2052" );
	System.out.println( "Microsoft Edge (Execution Target): 27297.2053" );
	
        System.out.println( "\r\nSites and Pages" );
        System.out.println( "omayo.blogspot.com (Site): 27297.2059" );
        System.out.println( "omayo (QAFox.com) (Page): 27297.2063" );
        
        System.out.println( "\r\nData Sources" );
        
        System.out.println( "\r\nPlugins" );
        System.out.println( "Integrated Selenium Server (Plugin): 27297.2048" );
        System.out.println( "HTML Generator (Plugin): 27297.2054" );
        System.out.println( "Alchemy Execution Console (Plugin): 27297.2055" );
      ...
      if ( cli.hasOption( "a" ) ) {
        ...
        SuiteExecutionWrapper.instance().setName("sa");
      }
      if ( cli.hasOption( "u" ) ) {
      ...
      if ( cli.hasOption( "d" ) ) {
        ...
        SuiteExecutionWrapper.instance().setDescription("No description was added for sa");
      }
      ...
      if ( hasValue( "it", "27297.2057" ) ) {
        if ( 0 == 0 || ( 0 == 1 && cli.hasOption( "rd" ) ) || ( 0 == 2 && cli.hasOption( "rq" ) ) ) {
          TestManager.instance().registerTest( new org.org_1.sa.test1() );
          testList.add("Test1");
        }
      }
      ...
      Router r;
      /*
      Routers from sa Execution Package
      Add a description of sa Execution Package
      */
      if ( hasValue( "ir", "27297.2050" ) ) { 
        r = new Router( 1, "sa router", "27297.2050" ,"{\"name\":\"sa router\",\"description\":\"Add a description of sa router\",\"alchemyId\":2050,\"alchemySeed\":27297,\"organizationId\":0,\"changed\":false,\"routerId\":1,\"status\":0,\"userId\":0,\"propertyList\":[{\"name\":\"URL\",\"value\":\"http://localhost:4444/wd/hub\"}]}" );
      ...
      ExecutionTarget eT;
      /*
      Targets from sa Execution Package
      Add a description of sa Execution Package
      */
      if ( hasValue( "ie", "27297.2051" ) ) {
        eT = new ExecutionTarget( "Chrome", "27297.2051", "27297.2050", 2 ,"{\"name\":\"Chrome\",\"description\":\"Add a description of Chrome\",\"alchemyId\":2051,\"alchemySeed\":27297,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2050,\"alchemySeed\":27297},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"chrome\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"referenceSuiteID\":0}" );
      ...
      if ( hasValue( "ie", "27297.2052" ) ) {
        eT = new ExecutionTarget( "Firefox", "27297.2052", "27297.2050", 2 ,"{\"name\":\"Firefox\",\"description\":\"Add a description of Firefox\",\"alchemyId\":2052,\"alchemySeed\":27297,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2050,\"alchemySeed\":27297},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"firefox\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"referenceSuiteID\":0}" );
        if ( eT.getMaximumAvailable() > 0 ) {
      ...
      if ( hasValue( "ie", "27297.2053" ) ) {
        eT = new ExecutionTarget( "Microsoft Edge", "27297.2053", "27297.2050", 2 ,"{\"name\":\"Microsoft Edge\",\"description\":\"Add a description of Microsoft Edge\",\"alchemyId\":2053,\"alchemySeed\":27297,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2050,\"alchemySeed\":27297},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"MicrosoftEdge\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"referenceSuiteID\":0}" );
        if ( eT.getMaximumAvailable() > 0 ) {
    ...
    public void start() {
      ...
      suitePayload.setSuiteDetail(  "{\"id\":6459,\"name\":\"sa\",\"description\":\"No description was added for sa\",\"userId\":12,\"userConfidence\":0,\"organizationId\":1,\"organizationConfidence\":0,\"status\":1,\"endpointId\":1,\"endpointStyleId\":1,\"targetId\":6625,\"targetConfigurationId\":0,\"targetVersionId\":0,\"reviewFlag\":0,\"importTests\":0,\"importFunctions\":0,\"importSites\":0,\"importTargets\":0,\"importData\":0,\"shareCount\":0,\"conductorList\":[{\"reviewFlag\":0,\"id\":5684,\"name\":\"sa Execution Package\",\"description\":\"Add a description of sa Execution Package\",\"alchemyId\":2049,\"alchemySeed\":27297,\"organizationId\":1,\"userId\":12,\"version\":0,\"targetDetail\":\"[{\\\"name\\\": \\\"Chrome\\\", \\\"status\\\": 0, \\\"userId\\\": 0, \\\"changed\\\": false, \\\"alchemyId\\\": 2051, \\\"alchemySeed\\\": 27297, \\\"description\\\": \\\"Add a description of Chrome\\\", \\\"propertyList\\\": [{\\\"name\\\": \\\"browserName\\\", \\\"value\\\": \\\"chrome\\\"}, {\\\"name\\\": \\\"platformName\\\", \\\"value\\\": \\\"ANY\\\"}], \\\"organizationId\\\": 0, \\\"maximumAvailable\\\": 2, \\\"referenceSuiteID\\\": 0, \\\"executionRouterID\\\": {\\\"alchemyId\\\": 2050, \\\"alchemySeed\\\": 27297}}, {\\\"name\\\": \\\"Firefox\\\", \\\"status\\\": 0, \\\"userId\\\": 0, \\\"changed\\\": false, \\\"alchemyId\\\": 2052, \\\"alchemySeed\\\": 27297, \\\"description\\\": \\\"Add a description of Firefox\\\", \\\"propertyList\\\": [{\\\"name\\\": \\\"browserName\\\", \\\"value\\\": \\\"firefox\\\"}, {\\\"name\\\": \\\"platformName\\\", \\\"value\\\": \\\"ANY\\\"}], \\\"organizationId\\\": 0, \\\"maximumAvailable\\\": 2, \\\"referenceSuiteID\\\": 0, \\\"executionRouterID\\\": {\\\"alchemyId\\\": 2050, \\\"alchemySeed\\\": 27297}}, {\\\"name\\\": \\\"Microsoft Edge\\\", \\\"status\\\": 0, \\\"userId\\\": 0, \\\"changed\\\": false, \\\"alchemyId\\\": 2053, \\\"alchemySeed\\\": 27297, \\\"description\\\": \\\"Add a description of Microsoft Edge\\\", \\\"propertyList\\\": [{\\\"name\\\": \\\"browserName\\\", \\\"value\\\": \\\"MicrosoftEdge\\\"}, {\\\"name\\\": \\\"platformName\\\", \\\"value\\\": \\\"ANY\\\"}], \\\"organizationId\\\": 0, \\\"maximumAvailable\\\": 2, \\\"referenceSuiteID\\\": 0, \\\"executionRouterID\\\": {\\\"alchemyId\\\": 2050, \\\"alchemySeed\\\": 27297}}]\",\"routerDetail\":\"[{\\\"name\\\": \\\"sa router\\\", \\\"status\\\": 0, \\\"userId\\\": 0, \\\"changed\\\": false, \\\"routerId\\\": 1, \\\"alchemyId\\\": 2050, \\\"alchemySeed\\\": 27297, \\\"description\\\": \\\"Add a description of sa router\\\", \\\"propertyList\\\": [{\\\"name\\\": \\\"URL\\\", \\\"value\\\": \\\"http://localhost:4444/wd/hub\\\"}], \\\"organizationId\\\": 0}]\",\"status\":1,\"lockUserId\":0,\"changed\":false,\"createDate\":\"Feb 5, 2025, 9:59:49 AM\",\"modifyDate\":\"Feb 5, 2025, 9:59:49 AM\",\"targetList\":[{\"name\":\"Chrome\",\"description\":\"Add a description of Chrome\",\"alchemyId\":2051,\"alchemySeed\":27297,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2050,\"alchemySeed\":27297},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"chrome\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"referenceSuiteID\":0},{\"name\":\"Firefox\",\"description\":\"Add a description of Firefox\",\"alchemyId\":2052,\"alchemySeed\":27297,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2050,\"alchemySeed\":27297},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"firefox\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"referenceSuiteID\":0},{\"name\":\"Microsoft Edge\",\"description\":\"Add a description of Microsoft Edge\",\"alchemyId\":2053,\"alchemySeed\":27297,\"organizationId\":0,\"changed\":false,\"maximumAvailable\":2,\"executionRouterID\":{\"alchemyId\":2050,\"alchemySeed\":27297},\"propertyList\":[{\"name\":\"browserName\",\"value\":\"MicrosoftEdge\"},{\"name\":\"platformName\",\"value\":\"ANY\"}],\"status\":0,\"userId\":0,\"referenceSuiteID\":0}],\"routerList\":[{\"name\":\"sa router\",\"description\":\"Add a description of sa router\",\"alchemyId\":2050,\"alchemySeed\":27297,\"organizationId\":0,\"changed\":false,\"routerId\":1,\"status\":0,\"userId\":0,\"propertyList\":[{\"name\":\"URL\",\"value\":\"http://localhost:4444/wd/hub\"}]}],\"acls\":[]}],\"version\":1,\"lockUserId\":0,\"testDisplay\":0,\"alchemyId\":2047,\"alchemySeed\":27297,\"referenceSuiteID\":0,\"changed\":false}" );
