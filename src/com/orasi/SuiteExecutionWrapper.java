...
//* A staging configuration containing a Staging URL */
      ...
      if ( cli.hasOption( "q" ) ) {
        ...
        System.out.println( "Test2 (Test): 27297.2110" );
	...
	System.out.println( "Microsoft Edge (Execution Target): 27297.2053" );
      ...
      if ( hasValue( "it", "27297.2110" ) ) {
        if ( 0 == 0 || ( 0 == 1 && cli.hasOption( "rd" ) ) || ( 0 == 2 && cli.hasOption( "rq" ) ) ) {
          TestManager.instance().registerTest( new org.org_1.sa.test2() );
          testList.add("Test2");
        }
      }
